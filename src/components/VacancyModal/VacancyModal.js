...
const VacancyModal = (props) => {
  ...
  return (
    <React.Fragment>
      <Modal scrollable show={props.open} onHide={props.close} centered size={"lg"}>
        <Modal.Header closeButton>
          <Modal.Title>{props.data["job-name"]}</Modal.Title>
        </Modal.Header>
        ...
        <Modal.Body>
          ...
          <p>
            ...
            <br />
            <span className="mr-2">Сфера деятельности:</span>
            <span>{props.data.category.specialisation}</span>
            <br />
            ...
            <br />
            <span className="mr-2">График работы:</span>
            <span>{props.data.schedule}</span>
            <br />
            <span className="mr-2">Тип занятости:</span>
            <span>{props.data.employment}</span>
            {props.data.term ? (
              <React.Fragment>
                <br />
              ...
              <React.Fragment>
                ...
                <span
                  dangerouslySetInnerHTML={{
                    __html: props.data.requirement.qualification
                  }}
                />
              </React.Fragment>
            ) : null}
